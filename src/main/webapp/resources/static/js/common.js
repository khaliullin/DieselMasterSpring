$(document).ready(function() {
	...
	$('.row .btn-group-lg').on('click', function(e) {
		e.preventDefault();
		var $this = $(this);
	...
	$('.enter').mouseenter(function(){
		$(this).children('div.enter_menu').slideDown('normal');
	});
	$('.enter').mouseleave(function(){
		$(this).children('div.enter_menu').slideUp('normal');
	});

	$(".top_links_button").click(function () {
		$(".top_links ul").slideToggle();
	})
